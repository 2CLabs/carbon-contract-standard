...
contract CodeOfCaculate is UserAuth{   
    ...
    constructor(string memory in_name, string memory in_version, string memory in_content, address in_dataLayerAccount, bytes32 in_dataLayerHash) UserAuth() public {
